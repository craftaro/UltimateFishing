package com.songoda.ultimatefishing.command;
...
public class CommandManager implements CommandExecutor {
    ...
    private UltimateFishing instance;

    public CommandManager(UltimateFishing instance) {
        this.instance = instance;

        instance.getCommand("UltimateFishing").setExecutor(this);
        ...
        addCommand(new CommandSellAll(commandUltimateFishing));
